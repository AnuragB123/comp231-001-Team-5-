...
router.post('/ongoing',(req,res,next)=>{
    ...
    if(cookies.user!=null){
        ...
        console.log(cookies.user.todo_list)
        User.updateOne(newUser,{todo_list:cookies.user.todo_list ,
             ongoing_list:cookies.user.ongoing_list},(err,userFormDb)=>{
            if(err){
                console.log(err);
            }else{
                console.log("user updated: "+ userFormDb.todo_list);
...
router.post('/done',(req,res,next)=>{
    ...
    if(cookies.user!=null){
        ...
        User.updateOne(newUser,{done_list:cookies.user.done_list ,
             ongoing_list:cookies.user.ongoing_list},(err,userFormDb)=>{
            if(err){
                console.log(err);
            }else{
